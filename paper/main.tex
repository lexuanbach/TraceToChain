...
\author{\IEEEauthorblockN{Phat T. Tran-Truong \href{https://orcid.org/0000-0003-3199-6333}{\includegraphics[scale=0.004]{sugg.png}}, Xuan-Bach Le$^{\text{(\Letter)}}$ \href{https://orcid.org/0009-0003-6848-5403}{\includegraphics[scale=0.004]{sugg.png}}}
...
\input{sections/05_state_construction.tex}
\input{sections/06_analytic_tools.tex}
\input{sections/07_extensions.tex}
\input{sections/08_simulation_validation.tex}
\input{sections/09_empirical_case_studies.tex}
\input{sections/13_ss10_swebench_real.tex}
\input{sections/16_ss15_taubench.tex}
\input{sections/14_robustness.tex}
\input{sections/10_threats_to_validity.tex}
